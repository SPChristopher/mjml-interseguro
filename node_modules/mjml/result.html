     ...
     <!--[if mso | IE]>
          ...
          >
            <tr>
              <td  style="font-size:0;height:30px;vertical-align:middle;width:30px;">
                    ...
                    <img
                       height="30" src="https://images.unsplash.com/photo-1518791841217-8f162f1e1131?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80" style="border-radius:3px;display:block;" width="30"
                    />
      ...
      >
        <td  style="padding:4px;">
          ...
          <td  style="vertical-align:middle;">
            <a
                 href="https://twitter.com/home?status=https://mjml.io/" style="color:#333333;font-size:15px;font-family:Ubuntu, Helvetica, Arial, sans-serif;line-height:22px;text-decoration:none;" target="_blank">
              Twitter
            </a>
          </td>
      ...
      <table
         border="0" cellpadding="0" cellspacing="0" role="presentation" style="margin:0px;"
      >
